  ...
  return (
    ...
    <div className="min-vh-100 divMain">
      ...
      <div className='d-flex flex-column align-items-center justify-content-center HeaderPhotoSpacer'>
        ...
        <div className="AboutMeBox d-flex flex-column align-items-start">
          ...
          <p className="mt-4 px-5">
            &ensp; &ensp; This love for problem solving also manifests itself in an outdoor setting, where I’m passionate about spending time outside and being active and growing my skills in these unique and challenging environments. During the summers I enjoy surfing, trail running, bouldering, and rock climbing. But winter time is my absolute favourite time of the year, whether I'm resort snowboarding, splitboarding, ice climbing, high altitude mountaineering, or even on an expedition exploring remote regions of the western US. The opportunity to push myself physically while also growing technically in the mountain environment is something I’m passionate about.
          </p>
          <p className="mt-4 px-5">
          ...
          <div class="mt-5 container d-flex align-items-center justify-content-center">
            <div class="row">
              <div class="col mx-5 programLanguagesBox">
                ...
                <ul className="mt-3 mx-5 px-3 text-left">
              ...
              <div class="col mx-5 programLanguagesBox2">
                ...
                <ul className="mt-3 mx-5 text-left">
